...
​Key Features
​Secure File Uploads: 
Integrated with Cloudinary for efficient, secure, and optimized media/document handling.

​Cloud Database:
Utilizes Firebase Firestore to store candidate metadata, scores, and application history securely.
...
​AI-Powered Analysis:
Implements natural language processing logic to extract keywords and calculate candidate fit percentages.

​Admin Dashboard: 
A dedicated interface for recruiters to view, manage, and shortlist candidate applications.
